...
<Text text="Javascript possui 2 escopos: global e local. Variáveis declaradas fora de uma função são globais. Variáveis declaradas dentro de uma função são locais" />
