...
// allPokes // ['Charmander', 'Bulbasaur', 'Squirtle']
```
...
reversed // ['Squirtle', 'Bulbasaur', 'Charmander']
```
...
alphabetic // ['Bulbasaur', 'Charmander', 'Squirtle']
```
